 ...
 */
#ifndef TOWERDEFENSE_EVENT_H
#define TOWERDEFENSE_EVENT_H
...
constexpr towerdefense::EventType operator"" _type(const char *str, std::size_t sz) {
  return towerdefense::Hash(str, sz);
}

#endif // TOWERDEFENSE_EVENT_H
