...
#include <towerdefense/Animation.h>
...
public:
  Ninja(towerdefense::ResourceManager& manager)
...
int main(int argc, char *argv[]) {
  ...
  fs::path datadir_path = bindir_path / fs::path("\\res\\foo");
  ...
  world.addEntity(&ninja, towerdefense::Memory::FROM_STACK);
